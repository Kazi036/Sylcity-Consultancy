...
const contactDetails = [
  ...
  },
  {
    icon: MapPin,
    label: "Office",
    value: "Rang Mohol Tower 4th Floor (Lift 3rd), Bandar Bazar, Sylhet, Bangladesh, 3100",
  },
]
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-4 leading-relaxed text-muted-foreground">
              Reach out for a FREE consultation. Our consultant will contact you within one business day.
            </p>
            ...
            {submitted ? (
              <div className="flex h-full flex-col items-center justify-center gap-5 py-10 text-center">
                ...
                <p className="leading-relaxed text-muted-foreground">
                  Thank you for choosing Sylcity Consultancy.
                  <br />
                  Our consultant will contact you within next 1 Hour.
                  <br />
                  Please keep your phone active.
                </p>
                <p className="text-sm text-muted-foreground">
                  This page will automatically reset in 10 seconds.
                </p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    {email.length > 0 && (
                      emailValid ? (
                        ...
                        <p className="text-sm font-medium text-red-600">Invalid Email Address</p>
                      )
                    )}
                  </div>
                </div>
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                  <div className="flex flex-col gap-2">
                    ...
                    {phone.length > 0 && (
                      phoneValid ? (
                        <p className="text-sm font-medium text-green-600">✓ Valid Bangladesh Phone Number</p>
                      ) : (
                        <p className="text-sm font-medium text-red-600">Invalid Phone Number</p>
                      )
                    )}
                  </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {message.length > 0 && (
                    messageValid ? (
                      <p className="text-sm font-medium text-green-600">✓ Message looks good.</p>
                    ) : (
                      <p className="text-sm font-medium text-red-600">Message must contain at least 10 characters.</p>
                    )
                  )}
                </div>
                ...
                <Button
                  type="submit"
                  size="lg"
                  disabled={loading || !phoneValid || !emailValid || !messageValid || service === ""}
                  className="w-full"
                >
                  {loading ? (
                ...
                <p className="text-center text-xs leading-relaxed text-muted-foreground">
                  By submitting this form, you agree to be contacted by Sylcity Consultancy regarding your enquiry.
                </p>
              </form>
            )}
          </div>
